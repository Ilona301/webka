            ...
            <div className="w-full max-w-[1400px] lg:w-[90%] xl:w-[80%] flex justify-center flex-col gap-6 sm:gap-8 lg:gap-10">
                ...
                <div className="hidden lg:flex items-start justify-center gap-8 xl:gap-12">
                    <div className="flex flex-col gap-3 w-full">
                        ...
                        <div>
                            ...
                            <div className="flex justify-end items-end w-full mt-2">
                                <img className="object-contain h-[60px] xl:h-[80px] w-auto"
                    ...
                    <div className="flex flex-col gap-3 border-l border-r border-[#453336] px-6 xl:px-8 w-full">
                        <img className="object-contain h-[60px] xl:h-[80px] w-auto" src="/images/lamp.svg" alt="lamp"/>
                    ...
                    <div className="flex flex-col gap-3 border-r border-[#453336] pr-6 xl:pr-8 w-full">
                        ...
                        <img className="w-auto h-[60px] xl:h-[80px] object-contain ml-auto"
                    ...
                    <div className="flex flex-col gap-3 justify-start items-center w-full">
                        ...
                        <div>
                            ...
                            <img className="object-contain w-auto h-[60px] xl:h-[80px] mx-auto mt-2"
                ...
                <div className="lg:hidden grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                    {/* Step 1 */}
                    <div className="flex flex-col gap-3 border-b-2 border-[#453336] p-4 sm:p-5 ">
                        ...
                        <div>
                            ...
                            <div className="flex justify-end items-end w-full">
                                <img className="object-contain h-[40px] w-10 scale-300"
                    ...
                    <div className="flex flex-col gap-3 border-b-2 border-[#453336] p-4 sm:p-5 ">
                        <div className="flex justify-start">
                            <img className="object-contain h-[40px] w-20 scale-300" src="/images/lamp.svg" alt="lamp"/>
                        </div>
                    ...
                    <div className="flex flex-col gap-3 border-b-2 border-[#453336] p-4 sm:p-5 ">
                        ...
                        <div className="flex justify-end">
                            <img className="h-[40px] w-20 scale-300 object-contain"
                    ...
                    <div className="flex flex-col gap-3  p-4 sm:p-5 ">
                        ...
                        <div>
                            ...
                            <div className="flex justify-start mt-3">
                                <img className="object-contain h-[40px] w-20 scale-300"
                                     src="/images/rocket.svg" alt="rocket"/>
                            </div>
                        </div>
                    </div>
